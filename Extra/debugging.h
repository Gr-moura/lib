...
template <typename T, size_t SZ> std::ostream &operator<<(std::ostream &out, const std::array<T, SZ> &arr);

template <typename T, typename C, typename A> std::ostream &operator<<(std::ostream &out, const std::set<T, C, A> &set);
